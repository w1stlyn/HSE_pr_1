...
**Задача скрипта** — «обойти» входную директорию и скопировать все файлы из неё (и из всех вложенных директорий) в выходную директорию, но уже без иерархии, а просто все файлы — внутри выходной директории.
...
Тогда после работы вашего скрипта структура `/home/output_dir` должна быть следующей:
